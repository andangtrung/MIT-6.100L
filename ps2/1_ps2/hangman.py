...
def get_revealed_letter(secret_word, available_letters):
    ...
    available_letters: string, comprised of letters that have not yet been guessed.
    
    returns: string, an unguessed letter in secret_word
    """
    choose_from = ""
    ...
    while True:
        ...
        if guess.isalpha() and len(guess) == 1:
            ...
            if guesses_remaining >= 3:
                guesses_remaining -= 3
                guess = get_revealed_letter(secret_word, available_letters)
                letters_guessed += guess
                word_progress = get_word_progress(secret_word, letters_guessed)
